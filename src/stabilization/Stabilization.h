...
class Stabilization {
  private:
    const float mixing = 0.2;  // ÄNDERN, aber wird anscheinend letztendlich mit .G (aus ControlLoopConstants.h) multipliziert, es reicht also einen dieser Parameter zu ändern
