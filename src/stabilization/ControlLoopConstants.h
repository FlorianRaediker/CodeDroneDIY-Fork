...
class ControlLoopConstants : public SingletonSimple<ControlLoopConstants> {
  public:
    ...
    Constants accroSpeed = {.G = 0.010, .Kp = 192*0.22, .Kd = 0.0, .Ki = 0};  // ÄNDERN für AcccroMode; wird in ControlLoop.cpp verwendet
    ...
    Constants yawSpeed = {.G = 0.010, .Kp = 192*0.7, .Kd = 0.0, .Ki = 0.0};  // ÄNDERN für AccroMode oder AngleMode
};
